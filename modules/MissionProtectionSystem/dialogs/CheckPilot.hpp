...
class CheckPilot
{
	...
	class controls
	{
		class GeCo_CheckPilot_Background : GeCo_RscText
		{
		...
		class GeCo_CheckPilot_RscEdit : GeCo_RscEdit
		{
            idc = 1600;
			text = "";
			canModify = 1;
		...
		class GeCo_CheckPilot_Submit : GeCo_RscButton
		{
            idc = 1700;
            ...
            action = "if(ctrlText 1600 == ""Pilot"") then {[true,""CheckPilot"",3,false,true] call MPS_fnc_PW;} else {[false,""CheckPilot"",3,false,true] call MPS_fnc_PW;}; closeDialog 0;";
		};
	};
};