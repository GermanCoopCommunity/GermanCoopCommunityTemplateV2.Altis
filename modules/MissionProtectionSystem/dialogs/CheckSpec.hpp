...
class CheckSpec
{
	...
	class controls
	{
		...
		{
			text = "Dies ist ein Zuschauerslot. Bitte Passwort eingeben:";
		...
		class GeCo_CheckCurator_Submit : GeCo_RscButton
		{
            ...
            action = "if(ctrlText 1600 isEqualTo ""Spec"") then {PW_correct = true;} else {PW_correct = false;}; closeDialog 0;";
		};
	};
};