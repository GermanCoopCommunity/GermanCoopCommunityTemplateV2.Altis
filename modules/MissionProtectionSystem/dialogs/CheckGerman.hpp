...
class CheckGerman
{
	...
	class controls
	{
		...
		class GeCo_CheckGerman_Submit : GeCo_RscButton
		{
            ...
            action = "if(ctrlText 1600 isEqualTo ""deutsch"") then {[true,""CheckGerman"",3,false,true] call MPS_fnc_PW;} else {[false,""CheckGerman"",3,false,true] call MPS_fnc_PW;}; closeDialog 0;";
		};
	};
};