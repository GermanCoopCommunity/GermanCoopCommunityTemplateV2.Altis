...
class FRP
{
	...
	class controls
	{
		...
		class GeCo_CheckGerman_Submit : GeCo_RscButton
		{
            ...
            action = "if(ctrlText 1600 isEqualTo ""rejoin"") then {[true,""FRP"",1,false,true] call MPS_fnc_PW;} else {[false,""FRP"",1,true,true] call MPS_fnc_PW;}; closeDialog 0;";
		};
	};
};