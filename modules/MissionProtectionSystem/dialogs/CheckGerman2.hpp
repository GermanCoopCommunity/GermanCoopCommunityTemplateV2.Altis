...
class CheckGerman2
{
	...
	class controls
	{
		...
		{
			text = " Wie heißt die Hauptstadt Deutschlands?";
		...
		class GeCo_CheckGerman_Submit : GeCo_RscButton
		{
            ...
            action = "if(ctrlText 1600 isEqualTo ""Berlin"") then {[true,""CheckGerman2"",3,false,true] call MPS_fnc_PW;} else {[false,""CheckGerman2"",3,false,true] call MPS_fnc_PW;}; closeDialog 0;";
		};
	};
};