...
class CheckGerman4
{
	...
	class controls
	{
		...
		{
			text = "Wer ist aktuell Bundeskanzler (Vorname Leerzeichen Nachname)?";
		...
		class GeCo_CheckGerman_Submit : GeCo_RscButton
		{
            ...
            action = "if(ctrlText 1600 isEqualTo ""Angela Merkel"") then {PW_correct = true;} else {PW_correct = false;}; closeDialog 0;";
		};
	};
};