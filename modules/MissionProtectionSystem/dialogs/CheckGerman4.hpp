...
class CheckGerman4
{
	...
	class controls
	{
		...
		class GeCo_CheckGerman_Submit : GeCo_RscButton
		{
            ...
            action = "if(ctrlText 1600 isEqualTo ""Angela Merkel"") then {[true,""CheckGerman4"",3,false,true] call MPS_fnc_PW;} else {[false,""CheckGerman4"",3,false,true] call MPS_fnc_PW;}; closeDialog 0;";
		};
	};
};