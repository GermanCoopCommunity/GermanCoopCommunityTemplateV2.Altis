...
if (uniform player in possCamoUnif) then
{
	...
	if !(typeOf player in Officers) then
	{
		switch (headgear player) do
		{
			...
			case "H_HelmetB": {player addHeadgear "H_HelmetB"};
			case "H_HelmetB_black": {player addHeadgear "H_HelmetB"};
			case "H_HelmetB_camo": {player addHeadgear "H_HelmetB"};
			case "H_HelmetB_desert": {player addHeadgear "H_HelmetB"};
			case "H_HelmetB_snakeskin": {player addHeadgear "H_HelmetB"};
			case "H_HelmetB_tna_F": {player addHeadgear "H_HelmetB"};
			case "H_HelmetB_sand": {player addHeadgear "H_HelmetB"};
			// if player wears Enhanced Combat Helmet
			case "H_HelmetSpecB": {player addHeadgear "H_HelmetSpecB"};
			case "H_HelmetSpecB_blk": {player addHeadgear "H_HelmetSpecB"};
			case "H_HelmetSpecB_paint2": {player addHeadgear "H_HelmetSpecB"};
			case "H_HelmetSpecB_sand": {player addHeadgear "H_HelmetSpecB"};
			case "H_HelmetSpecB_snakeskin": {player addHeadgear "H_HelmetSpecB"};
			case "H_HelmetB_Enh_tna_F": {player addHeadgear "H_HelmetSpecB"};
			// if player wears Light Combat Helmet
			case "H_HelmetB_light": {player addHeadgear "H_HelmetB_light"};
			case "H_HelmetB_light_black": {player addHeadgear "H_HelmetB_light"};
			case "H_HelmetB_light_desert": {player addHeadgear "H_HelmetB_light"};
			case "H_HelmetB_light_sand": {player addHeadgear "H_HelmetB_light"};
			case "H_HelmetB_light_snakeskin": {player addHeadgear "H_HelmetB_light"};
			case "H_HelmetB_Light_tna_F": {player addHeadgear "H_HelmetB_light"};
